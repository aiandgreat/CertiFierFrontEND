...
const CertificateCard = ({ cert }) => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://certifierbackend.onrender.com/api/certificates/${cert.id}/download/`, {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://certifierbackend.onrender.com/api/verify/${cert.certificate_id}/`, {
        headers: { Authorization: `Bearer ${token}` }
      });
